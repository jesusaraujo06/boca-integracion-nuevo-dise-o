...
<div class="row justify-content-center my-4">
	<div class="col-12 col-md-6 align-items-center ">
		<div class="alert alert-primary" role="alert">
			...
			Warning: deleting a problem will remove EVERITHING related to it.
			It is NOT recommended to change anythin while the contest is running.
  ...
  <div class="row mt-5 ">
    ...
    <table border="0">
      <tr>
        ...
        <td width="65%">
          <input type="text" class="form-control" name="problemnumber" value="" size="20" maxlength="20" />
        </td>
      </tr>
      <tr>
	 <td width="35%" align=right>Short Name (usually a letter, no spaces):</td>
        <td width="65%">
          <input type="text" class="form-control" name="problemname" value="" size="20" maxlength="20" />
        </td>
      </tr>
<!--
      <tr>
...
-->
	 ...
	 <td width="35%" align=right>Problem package (ZIP):</td>
        <td width="65%">
          <input type="file" class="form-control" name="probleminput" value="" size="40" />
        </td>
      </tr>
<!--
      <tr>
...
-->
      <tr>
        ...
        <td width="65%">
          <input type="text" class="form-control" name="colorname" value="" size="40" maxlength="100" />
        </td>
      </tr>
      <tr>
        <td width="35%" align=right>Color (RGB HTML format):</td>
        <td width="65%">
          <input type="text" class="form-control" name="color" value="" size="6" maxlength="6" />
        </td>
      </tr>
    </table>
  </div>
  ...
  <center class="my-4"> 
      ...
      <input type="reset" name="Submit4" class="btn btn-secondary" value="Clear">
  </center>

	 <br><br><br><center>To build a problem package from files, use this link:
      <input type="submit" name="Submit5"  class="btn btn-outline-primary "value="Build">
</center>
