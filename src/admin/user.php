...
// Comentamos el header.php, ya que crearemos nuestro propio header.
// require('header.php');
...
<div class="row justify-content-center py-4">
  <div class="col-12 col-md-6 align-items-center ">
    <div class="alert alert-primary" role="alert">
        Clicking on user number will bring the user data for edtion.
...
<form name="form1" enctype="multipart/form-data" method="post" action="user.php">
    ...
    <label for="">Import file</label>
      <div class="input-group mb-3">
        ...
        <div class="custom-file">
          <input type="file" name="importfile" size="40" class="custom-file-input" id="inputGroupFile01" aria-describedby="inputGroupFileAddon01">
  ...
  <center>
      <input type="submit"  class="btn btn-outline-light" name="Submit" value="Import" onClick="conf()">
      <input type="reset" class="btn btn-outline-light" name="Submit2" value="Clear">
  </center>
</form>
  ...
  <div class="row justify-content-center mt-5">
    <div class="col-12 col-md-6 align-items-center ">
      <div class="alert alert-primary" role="alert">
        ...
        (Specially care if you user a user number that is already existent).
    ...
    <div class="col-10">
          <table border="0">
            <tr> 
              ...
              <td width="65%">
          <input type="text" class="form-control" name="usersitenumber" <?php if(!$main) echo "readonly "; echo "value=\"" . $usite . "\""; ?> size="20" maxlength="20" />
              </td>
            </tr>
            <tr> 
              <td width="35%" align=right>User Number:</td>
              <td width="65%">
          <input type="text" class="form-control"  name="usernumber" value="<?php if(isset($u)) echo $u["usernumber"]; ?>" size="20" maxlength="20" />
              </td>
            </tr>
            <tr> 
              <td width="35%" align=right>Username:</td>
              <td width="65%">
          <input type="text" class="form-control"  name="username" value="<?php if(isset($u)) echo $u["username"]; ?>" size="20" maxlength="20" />
              </td>
            </tr>
            <tr> 
              <td width="35%" align=right>ICPC ID:</td>
              <td width="65%">
          <input type="text" class="form-control"  name="usericpcid" value="<?php if(isset($u)) echo $u["usericpcid"]; ?>" size="20" maxlength="50" />
              </td>
            </tr>
            <tr> 
          ...
          <option <?php if(isset($u) && $u["userenabled"] == "f") echo "selected"; ?> value="f">No</option>
            ...
            <tr> 
              ...
              <td width="65%">
          <select class="form-control"  name="usermultilogin">
          ...
          <option <?php if(!isset($u) || $u["usermultilogin"] != "t") echo "selected"; ?> value="f">No</option>
            ...
            <tr> 
              ...
              <td width="65%">
          <input class="form-control"  type="text" name="userfullname" value="<?php if(isset($u)) echo $u["userfullname"]; ?>" size="50" maxlength="200" />
              </td>
            </tr>
            <tr> 
              <td width="35%" align=right>User Description:</td>
              <td width="65%">
          <input type="text"  class="form-control"  name="userdesc" value="<?php if(isset($u)) { 
          ...
          echo $u["userdesc"]; } ?>" size="50" maxlength="300" />
            ...
            <tr> 
              ...
              <td width="65%">
          <input type="text" class="form-control"  name="userip" value="<?php if(isset($u)) echo $u["userpermitip"]; ?>" size="20" maxlength="20" />
              </td>
            </tr>
            <tr> 
              <td width="35%" align=right>Password:</td>
              <td width="65%">
          <input type="password" class="form-control"  name="passwordn1" value="" size="20" maxlength="200" />
              </td>
            </tr>
            <tr> 
              <td width="35%" align=right>Retype Password:</td>
              <td width="65%">
          <input type="password" class="form-control"  name="passwordn2" value="" size="20" maxlength="200" />
              </td>
            </tr>
            <tr> 
          ...
          <option <?php if(!isset($u) || !$u["changepassword"]) echo "selected"; ?> value="f">No</option>
            ...
            <tr> 
              ...
              <td width="65%">
          <input type="password"  class="form-control" name="passwordo" value="" size="20" maxlength="200" />
              </td>
            </tr>
          </table>
        ...
        <?php if(isset($u)) { ?>
              <input type="submit" class="btn btn-danger" name="Delete" value="Delete" onClick="conf4()">
        <?php } ?>
              <input type="submit" class="btn btn-secondary" name="Cancel" value="Cancel" onClick="conf5()">
        <?php if(isset($u)) { ?>
